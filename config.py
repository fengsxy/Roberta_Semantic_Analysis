...
def get_config():
    ...
    num_classes = {'amazon-jewel': 2,"amazon-jewel-debug":2,"amazon-jewel-5-debug":5}
    ''' Base '''
    parser.add_argument('--data_dir', type=str, default='data')
    parser.add_argument('--dataset', type=str, default='amazon-jewel', choices=num_classes.keys())
